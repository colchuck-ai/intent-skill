...
Markdown shells for **`docs/product/`** and **`docs/engineering/`**. Rules and placeholders: [`CONVENTIONS.md`](CONVENTIONS.md). **Workflow procedures** (draft → review → records) live under [`../references/`](../references/README.md).
...
| [`cr-simple.md`](cr-simple.md) | Root: `docs/product/crs/PROD-CR<NNN>-<kebab>.md`, `docs/engineering/crs/ENG-CR<NNN>-<kebab>.md`; nested: `…/crs/<scope>-CR<NNN>-<kebab>.md` ([`CONVENTIONS.md`](CONVENTIONS.md)) |
